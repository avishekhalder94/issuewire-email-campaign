...
const TemplateList = () => {
    ...
    const fetchProjects = (page = 0) => fetch('http://emailcampaign.frontpews.com/public/api/template/page/' + page)
        .then((res) => res.json())
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    axios({
                        method: 'delete',
                        url: 'http://emailcampaign.frontpews.com/public/api/template/' + tempId
