...
const AddImage = () => {
    ...
    const fetchProjects = (page = 0) => fetch('http://emailcampaign.frontpews.com/public/api/campaign/page/' + page)
        .then((res) => res.json());
    const {
        isIdle,
        isLoading,
    ...
    const formsubmit = (e) => {
        ...
        if (selectedFile != null) {
            ...
            axios({
                method: 'post',
                url: 'http://emailcampaign.frontpews.com/public/api/imageupload',
                data: formData,
                config: config,
                                                        ...
                                                        <tr key={i}>
                                                            ...
                                                            <td>
                                                                <picture>
                                                                    ...
                                                                    <img src="https://helpx.adobe.com/content/dam/help/en/photoshop/using/convert-color-image-black-white/jcr_content/main-pars/before_and_after/image-before/Landscape-Color.jpg" className="img-fluid img-thumbnail" height={"50px"} width={"50px"} />
                                                                </picture>
                                                            </td>
                                                            <td><p>https://helpx.adobe.com/content/dam/help/en/photoshop/using/convert-color-image-black-white/jcr_content/main-pars/before_and_after/image-before/Landscape-Color.jpg</p></td>
                                                            <td><button type="button" className="btn btn-outline-success btn-sm" onClick={() => imageLinkCopy(i, "abcdefghijklmnopqrst")} >{(isCopy.includes(1)) ? "copied!" : "copy"}</button></td>
                                                        </tr>
                                                    ))}
